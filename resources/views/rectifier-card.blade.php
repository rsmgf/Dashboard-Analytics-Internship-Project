    ...
    <main class="main-content">
        ...
        <div class="rectifier-content">
            ...
            <div class="last-updated">
                <a href="{{ url('/pops') }}" class="back-button" title="Kembali ke List POP">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <span>Last updated by Liqa - 07 Aug 2026, 08:00 WIB</span>
            </div>
                ...
                @foreach ($rectifiers as $rectifier)
                    <div class="rectifier-card">
                        ...
                        <div class="rectifier-information">
                            ...
                            <div class="equipment-info">{{ $rectifier['model'] }}</div>
                            <div class="equipment-info serial">{{ $rectifier['serial'] }}</div>
                        </div>
                        ...
                        <div class="rectifier-card-footer">
                            <a href="{{ url('/rectifier-detail') }}" class="detail-button">
                                <span>Detail</span>
