                            ...
                            <div class="form-card" style="padding-bottom: 24px;">
                                ...
                                <div class="form-actions"
                                    ...
                                    <button type="submit" class="btn-submit"
                                        style="background: #0284c7; color: white; border: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; font-size: 14px;">
