            ...
            ================================================ --}}
                <div class="rform-section">
                    ...
                    <div class="rform-section-body">
                        ...
                        {{-- Nomor Recti (auto-generate, read-only di edit) --}}
                        <div class="rform-row rform-row-2">
                            <div class="rform-group">
                                ...
                                <input type="text" class="rform-input"
                                       value="{{ $rectifier->nomor_recti }}" readonly
                                ...
                                <div style="display:flex; flex-direction:column; gap:14px;">
                                    ...
                                    <div class="rform-group">
                                        ...
                                        <input type="text" name="sn_rectifier"
                                            ...
                                            value="{{ old('sn_rectifier', $rectifier->sn_rectifier) }}"
                                    ...
                                    <div class="rform-group">
                                        ...
                                        <input type="number" name="kapasitas_slot" id="kapasitas_slot"
                                            ...
                                            value="{{ old('kapasitas_slot', $rectifier->kapasitas_slot) }}"
                                            placeholder="Contoh: 9" min="1">
                                ...
                                <div style="display:flex; flex-direction:column; gap:14px;">
                                    ...
                                    <div class="rform-group">
                                        ...
                                        <input type="text" name="kapasitas_modul" id="kapasitas_modul"
                                            class="rform-input"
                                            value="{{ old('kapasitas_modul', $rectifier->modules->first()?->kapasitas_ampere) }}"
                                    ...
                                    <div class="rform-group">
                                        ...
                                        <input type="number" name="jumlah_modul" id="jumlah_modul_input"
                                            class="rform-input"
                                            value="{{ old('jumlah_modul', $rectifier->modules->count()) }}"
                                    ...
                                    <div class="rform-group">
                                        <label class="rform-label">Kapasitas Rectifier
                                            <small style="font-weight:400;color:#94a3b8">(A)</small>
                                        </label>
                                        <input type="text" name="kapasitas_rectifier" id="kapasitas_rectifier"
                                            class="rform-input"
                                            value="{{ old('kapasitas_rectifier', $rectifier->kapasitas_rectifier) }}"
                                            placeholder="Contoh: 200" oninput="hitungUtilisasi()">
                                    </div>

                                    <div class="rform-group">
                                        <label class="rform-label">Beban
                                            <small style="font-weight:400;color:#94a3b8">(A)</small>
                                        </label>
                                    ...
                                    <div class="rform-group">
                                        ...
                                        <div style="position:relative;">
                                            <input type="text" name="utilisasi" id="utilisasi"
                                                class="rform-input"
                                                value="{{ old('utilisasi', $rectifier->utilisasi) }}"
                                                placeholder="Otomatis: Beban ÷ Kapasitas × 100" readonly
                                                style="background:#f1f5f9; color:#334155; cursor:not-allowed; padding-right:80px;">
                                            <span id="utilisasi_badge"
                                                style="position:absolute;right:10px;top:50%;transform:translateY(-50%);"></span>
                                        </div>
                                        <small style="color:#94a3b8;font-size:0.72rem;margin-top:3px;display:block;">
                                            <i class="bi bi-info-circle"></i> Terisi otomatis dari Beban ÷ Kapasitas
                                            Rectifier × 100
                                        </small>
                                    </div>
                                ...
                                <div class="rform-photo-preview">
                                    ...
                                    <div class="rform-preview-box">
                                        @if ($rectifier->foto_rectifier)
                                            ...
                                            <div class="rform-preview-empty" id="fotoEmpty" style="display:none;"><i
                                                    class="bi bi-image"></i><span>Belum ada foto</span></div>
                                        @else
                                            <img id="fotoPreview" src="" alt=""
                                                style="display:none;">
                                            <div class="rform-preview-empty" id="fotoEmpty"><i
                                                    class="bi bi-image"></i><span>Belum ada foto yang dipilih</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
